...
function spawnObstacleFire() {
   if(frameCount%500 ===0){
    fire = createSprite(Math.round(random(400,1000)),950);
   fire.velocityX =-10
...
function spawnObstacleBomb(){
   ...
   bomb = createSprite(Math.round(random(400,1000)),950);
   bomb.velocityX =-10
...
function spawnRewards(){
  if (frameCount%100 ===0){
    coin = createSprite(Math.round(random(300,600)),950);
    coin.velocityX =-5
  ...
  if (frameCount%50===0){
     cash = createSprite(Math.round(random(300,600)),950);
     cash.velocityX =-5
    ...
    if (frameCount%80===0){
      diamonds = createSprite(Math.round(random(300,600)),950);
